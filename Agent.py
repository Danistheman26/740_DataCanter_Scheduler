...
class Agent:
    def __init__(self, observation_dimensions, num_actions, steps_per_epoch, model_loc, from_saved=False):
        ...
        self.train_policy_iterations = 40  # amount of times we retrain the policy
        self.train_value_iterations = 40  # amount of times we update the value function
        self.lam = 0.93  # gae lambda is similar to gamma, should be between 0.9 and 1
        self.target_kl = 0.01  # 0.003 to 0.03
        self.hidden_sizes = (32, 32)  # neural network layers, 2 32 fully connected layers
